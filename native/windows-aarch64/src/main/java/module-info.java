/// Native LMDB library for Windows aarch64.
///
/// No Java code of its own — only bundled resources (`liblmdb.dll`), found
/// via [ClassLoader#getResourceAsStream(String)] from `io.github.dfa1.lmdb`
...
module io.github.dfa1.lmdb.natives.windows.aarch64 {
}
